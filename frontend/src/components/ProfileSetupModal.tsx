...
export default function ProfileSetupModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="profile-setup-title">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          >
            {isPending ? <><Loader2 className="w-4 h-4 animate-spin" /> Saving…</> : 'Save Profile'}
          </button>
        </form>
      </div>
    </div>
