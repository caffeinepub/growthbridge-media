...
export class Backend implements backendInterface {
    ...
    async approveInfluencer(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.approveInfluencer(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBrands(): Promise<Array<BrandInquiry>> {
        if (this.processError) {
            try {
    ...
    async getAllInfluencers(): Promise<Array<InfluencerApplication>> {
        if (this.processError) {
            try {
    ...
    async isInfluencerApproved(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isInfluencerApproved(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitBrandInquiry(arg0: BrandInquiry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitBrandInquiry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitInfluencerApplication(arg0: InfluencerApplication): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInfluencerApplication(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCampaignDealValue(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCampaignDealValue(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCampaignStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
